...
if (isset($_GET['view'])) {
    ...
    . "INNER JOIN USER_FRIENDS ON USERS.USERS_ID = USER_FRIENDS.FRIEND_ID\n" 
    . "INNER JOIN BEER ON USER_POST.BEER_ID = BEER.BEER_ID\n" 
    . "INNER JOIN BREWER ON BREWER.BREWER_ID = BEER.BEER_ID\n" 
    . "WHERE USER_FRIENDS.USERS_ID = $current_id AND USER_POST.USER_ID <> $current_id\n" 
...
?>
      <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <?php
        echo '<h4><a href="profile.php?id=' . $u_id . '"><span style="color:DarkGoldenRod;" class="glyphicon glyphicon-eye-open"></span>
